        ...
        <div class="container">
            <div class="board-container">
                <div class="board-wrapper" v-for="board in boards" :key="board.id">
                    <div @click.self="$router.push({name: 'Board', params: {id: board.id}})" class="board">
                        <input
                                ...
                                autofocus>
                        <span v-else @click.prevent="board.isEditInputActive = true">{{board.name}}</span>
                    </div>
                </div>
                <div class="board-wrapper">
                    <div class="board new-board" @click.prevent="isAddInputActive = true">
                        <input v-if="isAddInputActive"
